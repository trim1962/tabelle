...
\begin{figure}
	\begin{subfigure}[b]{.5\linewidth}
		\centering
	\includestandalone[width=8.5cm]{funzgonioTikz/acrsengrafico}
		\caption{Grafico di $\arcsen x$}
			\label{fig:ArcSenGrafico}
	\end{subfigure}%
	\begin{subfigure}[b]{.5\linewidth}
		\centering
	\includestandalone[width=8.5cm]{funzgonioTikz/acrcosengrafico}
		\caption{Grafico di $\arccos x$}
		\label{fig:ArcCosenGrafico}
	\end{subfigure}
		\begin{subfigure}[b]{\linewidth}
			\centering
	\includestandalone[width=8.5cm]{funzgonioTikz/arcotangente}
		\caption{Grafico di $\arctg x$}
...
La funzione inversa $\yb=\arcsen x$ associa ad un valore numerico compreso fra$[-1,+1]$ un angolo compreso in $[-\dfrac{\pi}{2},\dfrac{\pi}{2}]$. Il grafico\nobs\vref{fig:ArcSenGrafico} 
...
\midrule
\sen\alpha=\sen\beta & \alpha=\beta+k\ang{360} & \alpha=\ang{180}-\beta+k\ang{360} &\\
\midrule
\sen\alpha=-\sen\beta&&&\sen(-\beta)=-\sen\beta\\
...
\begin{figure}
	\begin{subfigure}[b]{.5\linewidth}
		\centering
	\includestandalone[width=7.5cm]{funzgonioTikz/EquaElementareCoseno3}
	\captionof{figure}{$\cos x=m$ $m=-1$}
	\label{fig:EquaElementareCoseno3}
	\end{subfigure}%
	\begin{subfigure}[b]{.5\linewidth}
		\centering
		\includestandalone[width=7.5cm]{funzgonioTikz/EquaElementareCoseno2}
		\captionof{figure}{$\cos x=m$ $m=+1$}
...
\midrule
\tg\alpha=\tg\beta &\alpha\neq\ang{90}+k\ang{180} & &\\
& \beta\neq\ang{90}+k\ang{180}& &\\
&&\alpha=\beta+k\ang{180}  &\\
\midrule
\tg\alpha=-\tg\beta & \alpha\neq\ang{90}+k\ang{180} & &\tg(\ang{180}-\beta)=-\tg(\beta)\\
& \beta\neq\ang{90}+k\ang{180}& &\\
