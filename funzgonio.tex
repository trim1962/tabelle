...
\begin{figure}
	...
	\captionof{figure}{Andamento cotangente $\ang{0}<\alpha<\ang{180}$}\label{fig:AndamentoCotangente11}
\end{figure}%
...
\end{figure}
\begin{proof}
	Consideriamo la figura\nobs\vref{fig:relFondGonio} per il triangolo POH vale il teorema di Pitagora\index{Teorema!Pitagora} \[a^2=b^2+c^2\] Dato che la circonferenza è una circonferenza goniometrica\[a=1\] \[c=\sen\alpha\]
	\[b=\cos\alpha\]
	otteniamo
