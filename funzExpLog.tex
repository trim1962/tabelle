...
\begin{figure}
	...
	\begin{subfigure}[b]{.4\linewidth}
		\centering
		\includestandalone[width=\textwidth]{funzioniBase/esempio1}
	...
	\centering
		\begin{subfigure}[b]{.4\linewidth}
			\centering
			\includestandalone[width=\textwidth]{funzioniBase/esempio2}
...
\begin{figure}
	...
	\begin{subfigure}[b]{.4\linewidth}
		\centering
		\includestandalone[width=\textwidth]{funzioniBase/esempio3}
	...
	%	\begin{subfigure}[b]{.4\linewidth}
	%		\centering
	%		\includestandalone[width=\textwidth]{funzioniBase/esempio4}
	%		\caption{Essere padre di}
...
\begin{figure}
	...
	\begin{subfigure}[b]{.4\linewidth}
		\centering
		\includestandalone[width=\textwidth]{funzioniBase/esempio5}
...
\begin{figure}
	...
	\begin{subfigure}[b]{.4\linewidth}
		\centering
		\includestandalone[width=\textwidth]{funzioniBase/esempio9}
		\caption{Radice quadrata}
	...
	\begin{subfigure}[b]{.4\linewidth}
		\centering
		\includestandalone[width=\textwidth]{funzioniBase/esempio8}
...
\begin{figure}
	...
	\begin{subfigure}[b]{.4\linewidth}
		\centering
		\includestandalone[width=\textwidth]{funzioniBase/esempio6}
		\caption{$a>1$}
	...
	\begin{subfigure}[b]{.4\linewidth}
		\centering
		\includestandalone[width=\textwidth]{funzioniBase/esempio7}
		\caption{$0<a<1$}
