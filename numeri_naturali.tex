...
L'addizione è un'operazione binaria\nobs\vref{fig:Nat_operazione_binaria}. I termini in ingresso si chiamano addendi\nobs\index{Operazione!somma}, il risultato somma. L'operazione di  somma è commutativa\index{Operazione!somma!commutativa} cioè combinando l'ordine degli addendi il risultato non cambia $2+3=3+2=5$. La somma ha un elemento neutro\index{Operazione!somma!elemento neutro} lo zero. L'elemento neutro è un addendo che sommato non modifica l'altro addendo.  $4+0=0+4=4$. La somma è associativa\index{Operazione!somma!associativa}. Quindi se sommo tre numeri la somma finale non cambia se il risultato della somma di due addendi viene sommato con il  terzo\nobs\vref{fig:ProprietaAddizione} $2+3+4=(2+3)+4=2+(3+4)$.
\begin{figure} %[htbp]
	\centering
