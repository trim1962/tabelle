...
\mediapriorita{Criteri di disibilità}
\begin{figure} %
	\centering
...
3 & Se & la somma delle cifre è divisibile per tre.Esempio \num{375} $3+7+5=15\div3=5$ infatti $375\div 3=125$ \\ 
 ...
 11 & Se& la differenza della somma delle cifre di posto pari e le cifre di posto dispari è zero o si divide per undici. Esempio $25652$ $(5+5)-(2+6+2)=0$ $25652\div 11=2332$.   \\    
 12 & Se & divisibile per tre e per quattro  \\  
 25 & Se & il numero formato dalle ultime due cigre è divisibile per venticinque\\
\bottomrule
\end{tabular}
...
\includestandalone[width=.6\linewidth]{numeri_naturali/AlberoBinario3}
	\caption[]{Scomposizioni di $1350$}
	\label{fig:AlberoBinario3}
\end{figure}%
\begin{figure} 
\centering
\includestandalone[width=.6\linewidth]{numeri_naturali/AlberoBinario6}
	\caption[]{Scomposizioni di $210$}
	\label{fig:AlberoBinario6}
\end{figure}%
\section{Massimo Comun Divisore}
\label{sec:macdNaturali}
Dati due o più numeri, il $\mcd$ è il numero\index{mcd} più grande in comune che li divide tutti. Vi sono casi, in cui il $\mcd$ vale uno, perché uno è l'unico numero che li divide. In questo caso si dice che i due numeri sono primi fra di loro.
 	\begin{figure}
	\centering
...
$a$&$b$&$a/b$&$r$\\
   ...
   Allineo le scomposizioni
    ...
    \begin{figure}
    	\centering
    \includestandalone[width=.8\linewidth]{numeri_naturali/AlberoBinario5}
