...
Iniziamo a introdurre un oggetto che utilizzeremo in seguito. Un albero binario\index{Albero Binario} è formato da una radice da cui si staccano due foglie. Ogni foglia può essere una radice da cui si staccano altre due foglie e così via. 
\begin{figure} %
	\centering
...
\begin{subfigure}[b]{.5\linewidth}
		\centering
\includestandalone[width=.8\textwidth]{numeri_naturali/AlberoBinario1}
	\caption{Scomposizione di $120$}
	\label{fig:AlberoBinario1}
\end{subfigure}%
\begin{subfigure}[b]{.5\linewidth}
	\centering
\includestandalone[width=.5\textwidth]{numeri_naturali/AlberoBinario2}
...
\begin{subfigure}[b]{.5\linewidth}
		\centering
\includestandalone[width=.8\textwidth]{numeri_naturali/AlberoBinario3}
	\caption{Scomposizione di $1350$}
	\label{fig:AlberoBinario3}
\end{subfigure}%
\begin{subfigure}[b]{.5\linewidth}
	\centering
\includestandalone[width=.5\textwidth]{numeri_naturali/AlberoBinario4}
	\caption{{Scomposizione di $1350$}  }
