...
\draw(P)--(PX) node[midway,above,sloped] {$\sen(\alpha)$};
\draw(Q)--(QX)node[midway,below,sloped] {$\sen(\ang{360}-\alpha)$};
\draw [->] (0:\sraggio/3) arc (0:\sangolo:\sraggio/3) node[sloped,below left] {$\ang{360}-\alpha$};
